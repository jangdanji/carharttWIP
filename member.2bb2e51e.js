...
xhr.onreadystatechange = function () {
  if (xhr.readyState === 4 && xhr.status === 200) {
    ...
    var _id = document.querySelector('input.idBox');
    var _tel = document.querySelector('select.telBox');
    ...
    btn.addEventListener('click', function () {
      if (_id.value === '' || tel1.value === '' || tel2.value === '') {
        return alert('정보를 모두 입력해 주세요.');
      }
      for (var i in userInfo) if (_tel.value + tel1.value + tel2.value == userInfo[i].phone && _id.value === userInfo[i].id) {
...
signupBtn.addEventListener('click', function () {
  ...
  for (var _i = 0; _i < alerts.length; _i++) {
    if (alerts[_i].style.color == 'red') return alert('입력한 정보를 다시 확인해 주세요!');
  }
  for (var _i2 = 0; _i2 < allInput.length; _i2++) {
    if (allInput[_i2].value == '') return alert('정보를 모두 입력해 주세요!!');
  }
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/member.js"], null)
//# sourceMappingURL=/member.2bb2e51e.js.map