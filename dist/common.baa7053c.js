...
var searchIcon = document.querySelectorAll('.gnb ul li:nth-child(4) i');
var icon1 = document.querySelector('.gnb .fa-search');
var icon2 = document.querySelector('.gnb .fa-minus-square');
icon2.style.fontSize = '18px';
var searchBar = document.querySelector('.gnb input');
searchIcon.forEach(function (i) {
  $(i).click(function () {
    $(icon1).toggle();
    $(icon2).toggle();
  });
...
setInterval(function () {
  ...
  $('.lnb .hot ul').animate({
    ...
    var myList = document.querySelectorAll('.lnb .hot ul li');
    var parent = myList[0].parentNode;
...
var category = document.querySelectorAll('.lnb .menuTop > li');
var menuImage1 = document.querySelector('.menuVisual .menuImg1 img');
var menuImage2 = document.querySelector('.menuVisual .menuImg2 img');
var categoryImgs = [];
for (var i = 1; i < _data.default.length; i++) {
  if (_data.default[i].name == 'lnb') categoryImgs.push(_data.default[i].src);
}
...
var login = document.querySelector('.gnb .btn-login');
var join = document.querySelector('.gnb .btn-join');
login.addEventListener('click', function () {
  return window.open('./login.html');
});
join.addEventListener('click', function () {
  return window.open('./signup.html');
});
