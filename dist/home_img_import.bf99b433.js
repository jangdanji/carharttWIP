...
},{}],"js/home_img_import.js":[function(require,module,exports) {
"use strict";
...
function imgSetter(imgCategory, path) {
  ...
  path.forEach(function (value, index) {
    ...
    hv.addEventListener('mouseover', function () {
      return hv.style.opacity = '1';
    });
    hv.addEventListener('mouseout', function () {
      return hv.style.opacity = '0';
    });
  });
}
var VisualSlides = document.querySelectorAll('.visual-main .swiper-slide img');
var bestSlides = document.querySelectorAll('.best-product .swiper-slide img');
var newSlides = document.querySelectorAll('.new-product .swiper-slide img');
var lookbooks = document.querySelectorAll('.product-accordion .accProduct img');
var mds = document.querySelectorAll('.mdsPick .pickProduct img');
var instaPics = document.querySelectorAll('.instagram .instaPicture img');
...
var instaSrc = [];
var insta = document.querySelectorAll('.instagram .instaPicture');
var _iterator2 = _createForOfIteratorHelper(_data.default),
  _step2;
try {
  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
    var i = _step2.value;
    if (i.name === 'instagram') {
      instaSrc.push(i.path);
    }
  }
} catch (err) {
  _iterator2.e(err);
...
insta.forEach(function (value, index) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/home_img_import.js"], null)
//# sourceMappingURL=/home_img_import.bf99b433.js.map