...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/detail_size_finder.js":[function(require,module,exports) {
...
find.addEventListener('click', function () {
  ...
  var result = '?';
  if (yourHeight.length == 0 || yourHeight.length == 0) alert('정보를 올바르게 입력해주세요!');else if (165 <= yourHeight && yourHeight < 172) {
    var bmi = getBmi(yourHeight, yourWeight);
    console.log(bmi);
    if (bmi < 18.5) result = 'XS';else if (bmi < 22) result = 'S';else if (bmi < 23.5) result = 'M';else if (bmi < 24.5) result = 'L';else alert('해당 사이즈의 상품이 존재하지 않습니다..');
  } else if (172 <= yourHeight && yourHeight < 178) {
    var _bmi = getBmi(yourHeight, yourWeight);
    if (_bmi < 18.5) result = 'S';else if (_bmi < 22) result = 'M';else if (_bmi < 23.5) result = 'L';else if (_bmi < 24.5) result = 'XL';else alert('해당 사이즈의 상품이 존재하지 않습니다..');
  } else if (178 <= yourHeight && yourHeight < 184) {
    var _bmi2 = getBmi(yourHeight, yourWeight);
    if (_bmi2 < 18.5) result = 'M';else if (_bmi2 < 22) result = 'L';else if (_bmi2 < 23.5) result = 'XL';else alert('해당 사이즈의 상품이 존재하지 않습니다..');
  } else if (184 <= yourHeight && yourHeight < 192) {
    var _bmi3 = getBmi(yourHeight, yourWeight);
    if (_bmi3 < 18.5) result = 'L';else if (_bmi3 < 22) result = 'XL';else alert('해당 사이즈의 상품이 존재하지 않습니다..');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/detail_size_finder.js"], null)
//# sourceMappingURL=/detail_size_finder.47b06b2c.js.map