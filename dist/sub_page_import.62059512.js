...
AllFilter.forEach(function (filter) {
  filter.addEventListener('change', function () {
    ...
    if (this.checked) checkList.push(data);else if (!this.checked) {
    ...
    _data.default.forEach(function (value) {
      ...
      if (clothChecked.length == 0) clothCheck = true;else clothCheck = clothChecked.some(function (cloth) {
        return value.category == cloth;
      });
      if (colorChecked.length == 0) colorCheck = true;else colorCheck = colorChecked.some(function (color) {
        return value.color == color;
      });
      if (priceChecked.length == 0) priceCheck = true;else {
